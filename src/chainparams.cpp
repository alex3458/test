...
public:
    CMainParams()
    {
        ...
        vSeeds.emplace_back("seed1.trumpcoin.com", true);     // Primary DNS Seeder from Liquid369
        vSeeds.emplace_back("seed2.trumpcoin.com", true);    // Secondary DNS Seeder from DanielHalford
